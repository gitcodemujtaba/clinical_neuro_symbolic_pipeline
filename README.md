...
| `docs/Knowledge_Graphs_Technical_Reference.md` | The TransE KG-embedding model: training, both evaluations, the gold-validated tiebreak test, and why it stays unwired from production. |
...
| `docs/Knowledge_Graphs_Technical_Reference.md` | KG3 write-back: both gated write paths, the HITL review-queue lifecycle, and the two mechanisms that repurpose reviewed labels back into the pipeline. |
